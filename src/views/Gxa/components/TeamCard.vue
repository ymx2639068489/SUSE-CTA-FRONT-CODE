...
const teamInfo = ref({})
const creatTeam = () => {
    post('/api/gxa_application/createApplicationForm', { teamName: teamInfo.value.teamName }).then(res => {
        ElMessage({
            type: "success",
        ...
        <div v-if="state == 1">
            <el-scrollbar height="40vh">
                <el-tag size="large" class="team-card-title">
                    <div>
                        国信安杯&nbsp;第{{ teamInfo.session }}届
                    </div>
                </el-tag>
                <div class="team-card-participator-group-continer">
                    <TeamCardParticipator :user="teamInfo.leader"></TeamCardParticipator>
                    <TeamCardParticipator :user="teamInfo.teamMember1" @mouseover="showKickBtn1 = true"
                        @mouseleave="showKickBtn1 = false">
                        <template #second-card>
                            <div v-show="showKickBtn1">
                                <el-popconfirm trigger="click" title="确认踢出队友?"
                    ...
                    <TeamCardParticipator :user="teamInfo.teamMember2" @mouseover="showKickBtn2 = true"
                        @mouseleave="showKickBtn2 = false">
                        <template #second-card>
                            <div v-show="showKickBtn2">
                                <el-popconfirm trigger="click" title="确认踢出队友?"
                ...
                <div>
                    ...
                    <div class="team-card-content">{{ teamInfo.group ? "动态组" : "静态组" }}</div>

                </div>
                <div>
                    <div class="card-title">团队特长</div>
                    <div class="team-card-content">{{ teamInfo.teamMemberSpecialty }}</div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="team-card-content">{{ teamInfo.introductionToWorks }}</div>
                </div>
                <!-- team leader show -->
                <div v-if="teamInfo.isLeader">
                        ...
                        <el-collapse-item name="changeInfo">
                            ...
                            <el-form label-position="top">
                                ...
                                <el-form-item label="参赛组别">
                                    <el-switch v-model="teamInfo.group" active-text="动态组" inactive-text="静态组">
                                    </el-switch>
                                </el-form-item>
                                <el-form-item label="队伍特长">
                                    <el-input type="textarea" :rows="5" v-model="teamInfo.teamMemberSpecialty">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="作品简介">
                                    <el-input type="textarea" :rows="5" v-model="teamInfo.introductionToWorks">
                                    </el-input>
                                </el-form-item>
                            </el-form>
                            <el-button type="success" @click="updateTeamInfo">更新信息</el-button>
            ...
            <div class="team-card-footer-continer">
                ...
                <div v-else class="team-card-operator-group">
                    ...
                    <el-button v-else type="primary" @click="submitInfo">提交团队信息</el-button>
